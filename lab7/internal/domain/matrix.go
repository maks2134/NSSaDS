...
// PanelCols extracts columns [colStart, colEnd) into dst (size Rows×panelW),
// column-contiguous in the sense of packed column panels stored row-major
// as rows×panelW: dst[i*panelW+k] = m[i, colStart+k].
